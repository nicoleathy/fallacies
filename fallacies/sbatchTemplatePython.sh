...
#SBATCH --partition=researchlong researchshort tanahhweeresearch                 # The partition you've been assigned
#SBATCH --account=tanahhweeresearch   # The account you've been assigned (normally student)
#SBATCH --qos=research-1-qos tanahhweeresearch-priority       # What is the QOS assigned to you? Check with myinfo command
#SBATCH --mail-user=nicolet.2023@engd.smu.edu.sg # Who should receive the email notifications
#SBATCH --job-name=Llama-2-7b-hf     # Give the job a name
